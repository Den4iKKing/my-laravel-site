...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/dashboard/bonuses.vue": () => import("./assets/bonuses-Cg90xoQV.js"), "./Pages/dashboard/categories.vue": () => import("./assets/categories-DUKc1sn9.js"), "./Pages/dashboard/index.vue": () => import("./assets/index-DY9AJ8eL.js"), "./Pages/dashboard/logs.vue": () => import("./assets/logs-iiztfhYt.js"), "./Pages/dashboard/promocode.vue": () => import("./assets/promocode-qj0wRmyT.js"), "./Pages/dashboard/servers.vue": () => import("./assets/servers-DuUvbomi.js"), "./Pages/dashboard/shop.vue": () => import("./assets/shop-BIotzF23.js"), "./Pages/dashboard/users.vue": () => import("./assets/users-CiqkQT6W.js"), "./Pages/index.vue": () => import("./assets/index-ZGaWfSdM.js") })
    ),
